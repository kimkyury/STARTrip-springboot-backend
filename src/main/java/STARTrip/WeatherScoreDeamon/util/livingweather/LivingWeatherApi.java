package STARTrip.WeatherScoreDeamon.util.livingweather;

import STARTrip.WeatherScoreDeamon.domain.weatherInfo.LivingWeatherInfo;
import STARTrip.WeatherScoreDeamon.util.OpenApiUtil;
